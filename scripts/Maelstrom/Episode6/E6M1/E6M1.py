...
def PreLoadAssets(pMission):
	...
	loadspacehelper.PreloadShip("Keldon", 18)
	loadspacehelper.PreloadShip("Hideki", 3)
...
#	kDebugObj.Print ("Initializing Episode 6, Mission 1.\n")
	...
	App.Game_SetDifficultyMultipliers(1.3, 1.1, 1.1, 1.0, 0.85, 0.9)
	...
	# Save the game
	MissionLib.SaveGame("E6M1A(Starbase12)-")
...
#	kDebugObj.Print("Initializing global variables")
	...
	g_lCardShipNames	= 	["Galor 1", "Galor 2", "Galor 3", "Galor 4", "Galor 5", "Galor 6", "Galor 7", "Galor 8", "Galor 9", "Galor 10", "Galor 11", "Galor 12", "Keldon 1", "Keldon 2", "Keldon 3", "Keldon 4", "Keldon 5", "Hideki 1", "Hideki 2", "Hideki 3", "Galor 13", "Galor 14"]
						
	# list of ships that will attack the user if they dont follow orders
	global g_lMoreCardShipNames
	g_lMoreCardShipNames	=	["Keldon 8", "Keldon 9", "Keldon 10", "Keldon 11", "Keldon 12", "Keldon 13", "Keldon 14", "Keldon 15", "Keldon 16", "Keldon 17", "Keldon 18", "Keldon 19", "Keldon 20"]
	
	# Global list of Cardassian ship names in Ona
	global g_lArtrusCardShipNames
	g_lArtrusCardShipNames	= 	["Galor 1", "Galor 2", "Galor 3", "Galor 4", "Keldon 1"]						
						
	# Global list of Cardassian ship names in Ona
	global g_lOnaCardShipNames
	g_lOnaCardShipNames	= 	["Galor 5", "Galor 6", "Galor 7", "Galor 8", "Galor 9", "Keldon 2", "Keldon 3"]
	
	# List of names of Cards that could warp to Savoy 1
	global g_lSavoy3WarpCards
	g_lSavoy3WarpCards	=	["Galor 11", "Galor 12", "Keldon 5"]
							
	# List of names for the transports
	global g_lTransportNames
	g_lTransportNames	= 	["Shannon", "Inverness", "Cambridge"]
							
	# Global lists of ship names
	global g_lFriendlyShips
	g_lFriendlyShips	= 	["Starbase 12", "Shannon", "Inverness", "Cambridge", "Devore", "San Francisco", "Venture", "USS Prometheus", "Savoy Station"]
...
def CreateSets():
	...
	pVBridgeSet	= MissionLib.SetupBridgeSet("VBridgeSet", "data/Models/Sets/defiantbridge/defiantbridge.nif", -30, 65, -1.55)
	pDawson		= MissionLib.SetupCharacter("Bridge.Characters.Dawson", "VBridgeSet")
	
	# Martin and the E-bridge set
	pEBridgeSet	= MissionLib.SetupBridgeSet("EBridgeSet", "data/Models/Sets/intrepidbridge/intrepidbridge.nif", -30, 65, -1.55)
...
def CreateStartingObjects(pMission):
	...
	pPlayer = MissionLib.CreatePlayerShip("SovereignR", pStarbaseSet, "player", "Player Start")
...
def CreateTargetGroups():
	...
	g_pGalor3_4Targets["USS Prometheus"]		= {"Priority" : 0.0}
	...
	g_pKeldon1Targets["USS Prometheus"]		= {"Priority" : 0.0}
	...
	g_pGalor5Targets["Venture"]			= {"Priority" : 1.5}
	g_pGalor5Targets["USS Prometheus"]		= {"Priority" : 2.0}
	...
	g_pGalor6Targets["USS Prometheus"]		= {"Priority" : 1.0}
	...
	g_pGalor7Targets["USS Prometheus"]		= {"Priority" : 1.0}
	...
	g_pKeldon2Targets["USS Prometheus"]		= {"Priority" : 1.0}
	...
	g_pGalor8Targets["Venture"]			= {"Priority" : 1.0}
	g_pGalor8Targets["USS Prometheus"]		= {"Priority" : 1.5}
	...
	g_pGalor9Targets["USS Prometheus"]		= {"Priority" : 1.0}
	...
	g_pKeldon3Targets["USS Prometheus"]		= {"Priority" : 0.5}
	...
	g_pKeldon4Targets["USS Prometheus"]		= {"Priority" : 0.0}
	...
	g_pGalor10Targets["USS Prometheus"]		= {"Priority" : 1.0}
	...
	g_pGalor11Targets["USS Prometheus"]		= {"Priority" : 1.0}
	...
	g_pGalor12Targets["USS Prometheus"]		= {"Priority" : 1.0}
	...
	g_pKeldon5Targets["USS Prometheus"]		= {"Priority" : 0.0}
	...
	g_pKeldon6Targets["USS Prometheus"]		= {"Priority" : 0.0}
	...
	g_pKeldon7Targets["USS Prometheus"]		= {"Priority" : 0.0}
...
def HailHandler(TGObject, pEvent):
	...
	if (pTarget):
		if (pTarget.GetName () == "San Francisco"):
			...
			pCallWaiting		= App.TGScriptAction_Create("MissionLib", "CallWaiting", TRUE)
			pKiskaHailing		= App.CharacterAction_Create(g_pKiska, App.CharacterAction.AT_SAY_LINE, "KiskaYes4", None, 0, g_pGeneralDatabase)
			pVentureHailed		= App.TGScriptAction_Create("MissionLib", "SubtitledLine", MissionLib.GetEpisode().GetDatabase(), "E6HailVenture", "Dawson")
			pEndCallWaiting		= App.TGScriptAction_Create("MissionLib", "CallWaiting", FALSE)
...
#	kDebugObj.Print("Federation ship destroyed")
	...
	elif (sShipName == "USS Prometheus"):
		g_bPrometheusDestroyed = TRUE
...
def LiuBriefing(pTGAction):
	...
	pSaffiCam			= App.TGScriptAction_Create("Actions.CameraScriptActions", "PlacementWatch", "bridge", "Saffi Head", "SaffiCam2")
	...
	pSequence.AddAction(pSaffiCam, pFelixIntro6, 1.5)
	pSequence.AppendAction(pViewCam1, 1.5)
	...
	pSequence.AddAction(pLiuLine003, pLiuLine001)
...
def PlayerArrivesArtrus():
	...
	#MissionLib.SaveGame("E6M1B(Arturus3)-")
...
def LiuSayGoToOna(pTGAction, pEvent):
	...
	pRestartProdTimer	= App.TGScriptAction_Create(__name__, "RestartProdTimer", 20)	# 20 sec prod timer
...
def CreateOnaFedShips():
	...
	pDevore		= loadspacehelper.CreateShip("Intrepid", pSet, "Devore", "DevoreWait")
	pVenture	= loadspacehelper.CreateShip("ExcelsiorR", pSet, "Venture", "VentureWait")
	pPrometheus	= loadspacehelper.CreateShip("Prometheus", pSet, "USS Prometheus", "Card1Enter")
...
#	kDebugObj.Print("PlayerArrivesOna()")
	...
	#MissionLib.SaveGame("E6M1C(Ona3)-")
...
def FallBackToSavoy():
	...
	pRestartProd	= App.TGScriptAction_Create(__name__, "RestartProdTimer", 20)	# 30sec on prod timer
...
def ResetFedShipAIForSavoy3(pTGAction):
	...
	import E6M1_AI_Prometheus_Savoy3
...
def PlayerArrivesSavoy3():
	...
	MissionLib.SaveGame("E6M1B(Savoy3)-")
...
def RescueWarping():
	...
	# If it's the Venture
		...
		# Get Dawson
		pDawson	= App.CharacterClass_GetObject(App.g_kSetManager.GetSet("VBridgeSet"), "Dawson")
		
		pViewOn		= App.TGScriptAction_Create("MissionLib", "ViewscreenOn", "VBridgeSet", "Dawson")
...
def CreateSecondSavoyWave(TGObject, pEvent):
	...
	pGalor10 = App.ShipClass_GetObject(None, "Galor 9")
...
def RescueCallsForHelp():
	...
	if (sSetName != "Savoy1"):
		...
		pRestartProd		= App.TGScriptAction_Create(__name__, "RestartProdTimer", 20)	# 20 sec on the prod timer
...
def CreateThirdSavoyWave(TGObject, pEvent):
	...
	# Create the ships
	pKeldon6	= loadspacehelper.CreateShip("Hideki", pSet, "Hideki 1", "Galor11Enter", 1)
	pKeldon7	= loadspacehelper.CreateShip("Hideki", pSet, "Hideki 2", "Keldon5Enter", 1)
	pHideki3	= loadspacehelper.CreateShip("Hideki", pSet, "Hideki 3", "Galor10Enter", 1)
	pGalor13	= loadspacehelper.CreateShip("Galor", pSet, "Galor 13", "Keldon4Enter", 1)
	pGalor14	= loadspacehelper.CreateShip("Galor", pSet, "Galor 14", "Galor12Enter", 1)
	...
	pHideki3.SetAI(E6M1_AI_Savoy1Keldon.CreateAI(pHideki3, g_pKeldon6Targets, "Galor10Enter"))
	pGalor13.SetAI(E6M1_AI_Savoy1Keldon.CreateAI(pGalor13, g_pKeldon7Targets, "Keldon4Enter"))
	pGalor14.SetAI(E6M1_AI_Savoy1Keldon.CreateAI(pGalor14, g_pKeldon7Targets, "Galor12Enter"))
...
def StationClearVenture():
	# Do the sequence
	pDBridge	= App.g_kSetManager.GetSet("VBridgeSet")
	...
	pDBridgeViewOn	= App.TGScriptAction_Create("MissionLib", "ViewscreenOn", "VBridgeSet", "Dawson")
...
def ShipSpecificCallForHelp():
	...
	pDBridgeSet	= App.g_kSetManager.GetSet("DBridgeSet")
	pEBridgeSet	= App.g_kSetManager.GetSet("EBridgeSet")
	pVBridgeSet	= App.g_kSetManager.GetSet("VBridgeSet")
	# Get all the characters we need
	pMartin	= App.CharacterClass_GetObject(pEBridgeSet, "Martin")
	pZeiss	= App.CharacterClass_GetObject(pDBridgeSet, "Zeiss")
	pDawson	= App.CharacterClass_GetObject(pVBridgeSet, "Dawson")
