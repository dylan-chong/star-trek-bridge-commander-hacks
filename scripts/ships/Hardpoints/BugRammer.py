...
Hull.SetMaxCondition(Custom.CrazyShipAbilities.Constants.BUG_RAMMER_HEALTH_MULTIPLIER * 6000.000000)
Hull.SetCritical(1)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 1.1 * 1.3 * 3600.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.REAR_SHIELDS, 1.1 * 2400.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 1.1 * 3600.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 1.1 * 3600.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.LEFT_SHIELDS, 1.1 * 2400.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.RIGHT_SHIELDS, 1.1 * 2400.000000)
...
WarpCore.SetPowerOutput(0.15 * 600.000000)
