...
#                                                              ShieldGeneratorShieldGlowColor.SetRGBA(1.000000, 1.000000, 0.250000, 1.000000)
...
#                                                              #################################################
#                                                              CardassianFacility = App.ShipProperty_Create("Cardassian Facility")
#                                                              
#                                                              CardassianFacility.SetGenus(2)
#                                                              CardassianFacility.SetSpecies(752)
#                                                              CardassianFacility.SetMass(7000.000000)
#                                                              CardassianFacility.SetRotationalInertia(800000000.000000)
#                                                              CardassianFacility.SetShipName("Card Facility")
#                                                              CardassianFacility.SetModelFilename("data/Models/Bases/CardStation/CardStation.nif")
#                                                              CardassianFacility.SetDamageResolution(10.000000)
#                                                              CardassianFacility.SetAffiliation(0)
#                                                              CardassianFacility.SetStationary(1)
#                                                              CardassianFacility.SetAIString("StarbaseAttack")
#                                                              CardassianFacility.SetDeathExplosionSound("g_lsBigDeathExplosions")
#                                                              App.g_kModelPropertyManager.RegisterLocalTemplate(CardassianFacility)
#                                                              
...
#                                                              	if (prop != None):
#                                                              		pObj.AddToSet("Scene Root", prop)
#                                                              	prop = App.g_kModelPropertyManager.FindByName("Cardassian Facility", App.TGModelPropertyManager.LOCAL_TEMPLATES)
#                                                              	if (prop != None):
#                                                              		pObj.AddToSet("Scene Root", prop)
