...
Hull.SetMaxCondition(1.0000 * 1000.000000)
Hull.SetCritical(1)
...
ImpulseEngines.SetMaxSpeed(15 * 9.523810)
...
ForwardPhaser1.SetMaxDamage(5 * 320.000000)
...
ForwardPhaser2.SetMaxDamage(5 * 320.000000)
