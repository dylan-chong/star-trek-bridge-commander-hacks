...
#################################################
Bug = App.ShipProperty_Create("Bug")

Bug.SetGenus(1)
Bug.SetSpecies(801)
Bug.SetMass(0.1 * 1061) # galor mass #(35.000000)
Bug.SetRotationalInertia(10000000 * 3500.000000)
Bug.SetShipName("Bug")
Bug.SetModelFilename("data/Models/Ships/Bug/Bug.nif")
Bug.SetDamageResolution(10.000000)
Bug.SetAffiliation(0)
Bug.SetStationary(0)
Bug.SetAIString("NonFedAttack")
Bug.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Bug)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Bug", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
