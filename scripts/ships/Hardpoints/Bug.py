...
PolaronBeams.SetMaxCondition(1000.000000)
...
PolaronBeams.SetNormalPowerPerSecond(105.000000)
...
ForwardBeam1.SetMaxCondition(2250.000000)
...
ForwardBeam2.SetMaxCondition(2250.000000)
...
ForwardBeam3.SetMaxCondition(2250.000000)
...
ForwardTube.SetMaxCondition(1500.000000)
...
AftTube.SetMaxCondition(1500.000000)
...
Bug.SetGenus(1)
Bug.SetSpecies(801)
Bug.SetMass(35.000000)
Bug.SetRotationalInertia(3500.000000)
Bug.SetShipName("Bug")
