...
ImpulseEngines.SetMaxAngularAccel(4 * 0.670000)
...
DorsalPhaser.SetMaxCharge(3 * 1.000000)
DorsalPhaser.SetMaxDamage(1 * 640.000000)
...
Torpedoes.SetTorpedoScript(0, "Tactical.Projectiles.ShotgunDefiantAntiproton")
...
ForwardTube1.SetPosition(-0.248, 0.340000, 0.017000)
...
ForwardTube1.SetReloadDelay(TorpedoReloadDelay)
...
ForwardTube2.SetPosition(0.248, 0.340000, 0.017000)
...
ForwardTube2.SetReloadDelay(TorpedoReloadDelay)
...
AftTube1.SetMaxCharge(MaxPhotonChargeFactor * 1.000000)
...
AftTube1.SetRechargeRate(PhotonRechargeRateFactor * 0.025000)
...
AftTube2.SetMaxCharge(MaxPhotonChargeFactor * 1.000000)
...
AftTube2.SetRechargeRate(PhotonRechargeRateFactor * 0.025000)
