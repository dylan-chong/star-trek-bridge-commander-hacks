...
Hull.SetMaxCondition(0.5 * 12000.000000)
Hull.SetCritical(1)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 0.14 * 12000.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.REAR_SHIELDS, 0.14 * 4800.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 0.14 * 4800.000000)
...
PulsePhasers.SetNormalPowerPerSecond(0.3 * 140.000000)
...
ForwardCannon1.SetCooldownTime(AAAAAAAAAAAAPulseCooldownTime)
ForwardCannon1.SetModuleName("Tactical.Projectiles.BurstDefiantPulsePhaser")
...
ForwardCannon2.SetMaxCharge(AAAAAAAAAMaxDefaultCannonCharge) # (9.000000)
ForwardCannon2.SetMaxDamage(AAAAAAAAAAAASetMaxDamage)
ForwardCannon2.SetMaxDamageDistance(AAAAAAAAAAAASetMaxDamageDistance)
ForwardCannon2.SetMinFiringCharge(AAAAAAAAAAAASetMinFiringCharge)
ForwardCannon2.SetNormalDischargeRate(1.000000)
ForwardCannon2.SetRechargeRate(AAAAAAAAAAAAPulseRechargeRate)
...
ForwardCannon2.SetCooldownTime(AAAAAAAAAAAAPulseCooldownTime)
ForwardCannon2.SetModuleName("Tactical.Projectiles.BurstDefiantPulsePhaser")
...
ForwardCannon3.SetMaxCharge(AAAAAAAAAMaxDefaultCannonCharge) # (9.000000)
ForwardCannon3.SetMaxDamage(AAAAAAAAAAAASetMaxDamage)
ForwardCannon3.SetMaxDamageDistance(AAAAAAAAAAAASetMaxDamageDistance)
ForwardCannon3.SetMinFiringCharge(AAAAAAAAAAAASetMinFiringCharge)
ForwardCannon3.SetNormalDischargeRate(1.000000)
ForwardCannon3.SetRechargeRate(AAAAAAAAAAAAPulseRechargeRate)
...
ForwardCannon3.SetCooldownTime(AAAAAAAAAAAAPulseCooldownTime)
ForwardCannon3.SetModuleName("Tactical.Projectiles.BurstDefiantPulsePhaser")
...
ForwardCannon4.SetMaxCharge(AAAAAAAAAMaxDefaultCannonCharge) # (9.000000)
ForwardCannon4.SetMaxDamage(AAAAAAAAAAAASetMaxDamage)
ForwardCannon4.SetMaxDamageDistance(AAAAAAAAAAAASetMaxDamageDistance)
ForwardCannon4.SetMinFiringCharge(AAAAAAAAAAAASetMinFiringCharge)
ForwardCannon4.SetNormalDischargeRate(1.000000)
ForwardCannon4.SetRechargeRate(AAAAAAAAAAAAPulseRechargeRate)
...
ForwardCannon4.SetCooldownTime(AAAAAAAAAAAAPulseCooldownTime)
ForwardCannon4.SetModuleName("Tactical.Projectiles.BurstDefiantPulsePhaser")
...
for i in range(NExtraCannons):
	...
	ExtraCannon.SetDumbfire(1)
	ExtraCannon.SetWeaponID(40 + i)
	...
	ExtraCannon.SetMaxDamage(AAAAAAAAAAAASetMaxDamage)
	ExtraCannon.SetMaxDamageDistance(AAAAAAAAAAAASetMaxDamageDistance)
	ExtraCannon.SetMinFiringCharge(AAAAAAAAAAAASetMinFiringCharge)
	ExtraCannon.SetNormalDischargeRate(1.000000)
	ExtraCannon.SetRechargeRate(AAAAAAAAAAAAPulseRechargeRate)
	...
	ExtraCannonForward = App.TGPoint3()
	ExtraCannonForward.SetXYZ(0.000000, 1.000000, 0.000000)
	ExtraCannonUp = App.TGPoint3()
	ExtraCannonUp.SetXYZ(0.000000, 0.000000, 1.000000)
	ExtraCannon.SetOrientation(ExtraCannonForward, ExtraCannonUp)
	ExtraCannon.SetArcWidthAngles(-0.174533, 0.174533)
	ExtraCannon.SetArcHeightAngles(-0.174533, 0.174533)
	ExtraCannon.SetCooldownTime(AAAAAAAAAAAAPulseCooldownTime)
	ExtraCannon.SetModuleName("Tactical.Projectiles.BurstDefiantPulsePhaser")
...
AAAAAAAAAAAATorpedoReloadDelay = 20#40.000000
...
ForwardTube2.SetReloadDelay(AAAAAAAAAAAATorpedoReloadDelay)
...
AftTube1.SetMaxCharge(1.5 * 1.000000)
...
AftTube1.SetRechargeRate(0.25000)
...
AftTube2.SetMaxCharge(1.5 * 1.000000)
AftTube2.SetMaxDamage(1200.000000)
AftTube2.SetMaxDamageDistance(1.2 * 100.000000)
AftTube2.SetMinFiringCharge(1.5 * 1.000000)
...
CloakingDevice.SetNormalPowerPerSecond(30 * 240.000000)
...
def LoadPropertySet(pObj):
	...
	for i in range(0, NExtraCannons):
		prop = App.g_kModelPropertyManager.FindByName("Forward Cannon " + str(i), App.TGModelPropertyManager.LOCAL_TEMPLATES)
		if (prop != None):
			pObj.AddToSet("Scene Root", prop)
