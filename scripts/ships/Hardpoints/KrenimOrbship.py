...
WarpCore.SetMainConduitCapacity(1.2 * 1350.000000)
...
DeathBeam.SetMaxDamage(5000.000000)
...
DeathBeam.SetArcWidthAngles(-0.090000, 0.090000)
DeathBeam.SetArcHeightAngles(-0.090000, 0.090000)
...
Torpedoes.SetMaxTorpedoes(0, NLoadableTorps * 2)
