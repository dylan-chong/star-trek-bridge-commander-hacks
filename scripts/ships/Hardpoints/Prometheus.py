...
ForwardTube1.SetReloadDelay(AAAAAAAAATorpReloadDelay)
...
ForwardTube2.SetReloadDelay(AAAAAAAAATorpReloadDelay)
...
ForwardTube3.SetReloadDelay(AAAAAAAAATorpReloadDelay)
...
AftTube1.SetReloadDelay(AAAAAAAAATorpReloadDelay)
...
AftTube2.SetReloadDelay(AAAAAAAAATorpReloadDelay)
